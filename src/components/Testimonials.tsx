  ...
  return (
    <section id="testimonials" className="mx-auto max-w-7xl px-4">
      <div className="mb-8 md:mb-12 text-center">
        <h2 className="font-display text-4xl md:text-5xl mb-4 bg-gradient-to-r from-stone-900 to-stone-600 bg-clip-text text-transparent">Testimonials</h2>
        <p className="text-stone-600 text-lg">What our clients say</p>
      </div>
